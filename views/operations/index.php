...
<div class="mb-2 d-flex align-items-center gap-2">
  ...
  <span class="fw-bold" style="color:#f97316;font-size:.82rem;letter-spacing:.5px;text-transform:uppercase">
    Ξεκινά σύντομα — <?= count($startingSoon) ?>
  </span>
  <span class="text-muted small">· Θα ανοίξει αυτόματα στην ώρα έναρξης</span>
</div>
        ...
        <div class="d-flex align-items-start justify-content-between gap-2 mb-2">
          <div>
            <span class="badge" style="background:#f97316">
              <i class="bi bi-hourglass-split me-1"></i>σε <?= (int)$ev['mins_until'] ?> λεπτά
            </span>
          ...
          <div class="text-end" style="font-size:.78rem;white-space:nowrap">
            ...
            <span class="text-muted">εγκεκρ. ομάδες</span>
          </div>
        </div>
        <div class="d-flex gap-2 mt-3 flex-wrap">
          ...
          <form method="post" action="<?= e(url('/events/' . $ev['id'] . '/activate')) ?>"
            ...
            <button class="btn btn-outline-warning w-100 fw-semibold btn-sm">
              <i class="bi bi-skip-start-fill me-1"></i>Πρόωρη έναρξη
            </button>
          </form>
          ...
          <div>
            ...
            <?php elseif ($isManual && $isPastEnd): ?>
              ...
              <span class="badge text-bg-secondary mb-1">
                <i class="bi bi-clock-history me-1"></i>Παράταση
              </span>
            <?php else: ?>
              <!-- Normal auto-live -->
    ...
    <table class="table table-hover mb-0 align-middle">
      <thead class="table-light">
        <tr>
          ...
          <th>Έναρξη</th>
          <th>Κατάσταση</th>
          <th class="text-center">Εγκεκρ.</th>
          <th></th>
        </tr>
      </thead>
      <tbody>
