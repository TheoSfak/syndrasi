<div class="d-flex flex-wrap justify-content-between align-items-center mb-1 gap-2">
  <h1 class="h3 mb-0">Στατιστικά: <?= e($team['name']) ?></h1>
...
<div class="mt-3">
  <a class="btn btn-outline-secondary" href="<?= e(url('/statistics?year=' . $year)) ?>"><i class="bi bi-arrow-left me-1"></i>Πίσω στα στατιστικά</a>
</div>
