<div class="d-flex align-items-center mb-3 gap-2">
  ...
  <div class="ms-auto">
    <a href="<?= e(url('/team/members/' . $member['id'] . '/certificate')) ?>" target="_blank"
      ...
      <i class="bi bi-file-earmark-text me-1"></i>Πιστοποιητικό PDF
    </a>
  </div>
</div>
  ...
  <div class="col-6 col-md-3">
    <div class="card shadow-sm text-center">
      <div class="card-body py-3">
        ...
        <div class="small text-muted">Ώρες εθελοντισμού</div>
      </div>
    </div>
  </div>
  <div class="col-6 col-md-3">
    <div class="card shadow-sm text-center">
      <div class="card-body py-3">
        ...
        <div class="small text-muted">Σύνολο εκχωρήσεων</div>
      </div>
    </div>
  </div>
  <div class="col-6 col-md-3">
    <div class="card shadow-sm text-center">
      <div class="card-body py-3">
        ...
        <div class="small text-muted">Φορές Υπεύθυνος</div>
      </div>
    </div>
  </div>
</div>
...
<div class="card shadow-sm">
  <div class="card-header bg-white fw-semibold d-flex justify-content-between align-items-center">
    <span><i class="bi bi-clock-history me-1"></i> Ιστορικό Συμμετοχών</span>
    ...
    <table class="table table-hover mb-0 align-middle">
      <thead class="table-light">
        <tr>
          ...
          <th class="text-center">Υπεύθυνος</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
            <?php if ((int) $p['was_present']): ?>
              <span class="badge text-bg-success"><i class="bi bi-check"></i> Παρών</span>
            <?php else: ?>
              <span class="badge text-bg-secondary">Απών</span>
            <?php endif; ?>
          </td>
  ...
  <div class="card-body text-muted small">
    <i class="bi bi-info-circle me-1"></i>Δεν υπάρχουν καταγεγραμμένες συμμετοχές ακόμη. Οι εγγραφές δημιουργούνται κατά την αρχειοθέτηση δράσεων.
  </div>
  <?php endif; ?>
</div>
