...
<title>Νέος κωδικός | SynDrasi</title>
  ...
  <div class="card login-card shadow-lg">
    <div class="card-body p-4 p-md-5">
      <div class="text-center mb-4">
        ...
        <h1 class="h3 fw-bold mb-1">Νέος κωδικός</h1>
        <p class="text-muted mb-0">Ορίστε τον νέο κωδικό πρόσβασής σας.</p>
      </div>
      ...
      <form method="post" action="<?= e(url('/reset-password')) ?>">
        ...
        <div class="mb-3">
          <label class="form-label" for="password">Νέος κωδικός</label>
          <input type="password" class="form-control form-control-lg" id="password" name="password"
                 required autofocus minlength="8" placeholder="Τουλάχιστον 8 χαρακτήρες">
          <div class="form-text">Ελάχιστο 8 χαρακτήρες.</div>
        </div>
        <div class="mb-4">
          ...
          <input type="password" class="form-control form-control-lg" id="confirm" name="confirm"
                 required minlength="8" placeholder="Επαναλάβετε τον κωδικό">
        </div>
        <button type="submit" class="btn btn-lg w-100 text-white mb-3" style="background:#0f766e">
          <i class="bi bi-check-circle me-1"></i> Αλλαγή κωδικού
        </button>
