...
> Version **0.6.0-beta** · PHP 8.1+ · MySQL/MariaDB · PWA
...
- **QR check-in** *(new in 0.6.0, optional)* — operators show a full-screen Gate QR;
  team leaders scan it to reach a one-tap check-in page on their phones.
...
See [`CHANGELOG.md`](CHANGELOG.md) for the history. Current: **0.6.0-beta**.
