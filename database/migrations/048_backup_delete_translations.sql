...
INSERT INTO translation_values (key_id, language_code, value) SELECT id, 'el', CONCAT('Οριστική διαγραφή αυτού του backup', CHAR(59), ' Δεν μπορεί να αναιρεθεί.') FROM translation_keys WHERE str_key = 'settings/index.092' ON DUPLICATE KEY UPDATE value = CONCAT('Οριστική διαγραφή αυτού του backup', CHAR(59), ' Δεν μπορεί να αναιρεθεί.');
...
INSERT INTO translation_values (key_id, language_code, value) SELECT id, 'el', CONCAT('Οριστική διαγραφή %d επιλεγμένων backups', CHAR(59), ' Δεν μπορεί να αναιρεθεί.') FROM translation_keys WHERE str_key = 'settings/index.094' ON DUPLICATE KEY UPDATE value = CONCAT('Οριστική διαγραφή %d επιλεγμένων backups', CHAR(59), ' Δεν μπορεί να αναιρεθεί.');
