...
$router->post('/f/{token}/video',    'FieldController@video');
$router->post('/f/{token}/pin',      'FieldController@pin');
...
$router->post('/operations/events/{id}/request-video', 'OperationController@requestVideo');
...
$router->post('/team/applications/{id}/regenerate-pin', 'TeamPortalController@regenerateFieldPin');
